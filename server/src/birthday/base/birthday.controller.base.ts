...
import { BirthdayUpdateInput } from "./BirthdayUpdateInput";
import { Birthday } from "./Birthday";
@swagger.ApiBearerAuth()
export class BirthdayControllerBase {
  constructor(
  ...
  @swagger.ApiCreatedResponse({ type: Birthday })
  @swagger.ApiForbiddenResponse({ type: errors.ForbiddenException })
  async create(
    @common.Body() data: BirthdayCreateInput,
  ...
  @swagger.ApiOkResponse({ type: [Birthday] })
  @swagger.ApiForbiddenResponse()
  @ApiNestedQuery(BirthdayFindManyArgs)
  async findMany(
    @common.Req() request: Request,
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<Birthday[]> {
    const args = plainToClass(BirthdayFindManyArgs, request.query);
  ...
  @swagger.ApiForbiddenResponse({ type: errors.ForbiddenException })
  async findOne(
    @common.Param() params: BirthdayWhereUniqueInput,
    @nestAccessControl.UserRoles() userRoles: string[]
